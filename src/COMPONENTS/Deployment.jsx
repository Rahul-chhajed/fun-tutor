...
function Deployment() {
  ...
  useEffect(() => {
    axios.post("https://fun-tutor-backend.onrender.com/generate-code", {
      quizTitle,
      quizTime,
      email,
    }, {
  ...
  const StartQuiz = () => {
    axios.post("https://fun-tutor-backend.onrender.com/start-quiz", {
      quizTitle,
      roomCode,
    }, {
      headers: {
  ...
  const endQuiz = (showToast = true) => {
    axios.post("https://fun-tutor-backend.onrender.com/end-quiz", {
      quizTitle,
      roomCode,
    }, {
      headers: {
