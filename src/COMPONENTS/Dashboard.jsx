...
function Dashboard() {
  ...
  const fetchQuizzes = async () => {
    try {
      const res = await axios.post(
        'https://fun-tutor-backend.onrender.com/api/quiz/my-quizzes',
  ...
  const handleDelete = async (quizTitle) => {
    try {
      await axios.delete(`https://fun-tutor-backend.onrender.com/api/quiz/delete/${encodeURIComponent(quizTitle)}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
      });
